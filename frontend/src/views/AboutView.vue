    ...
    <div class="content">
      ...
      <ul class="info">
        <li class="info-item">
          ...
          <a class="link" href="https://github.com/bestk/hosteditor">https://github.com/bestk/hosteditor</a>
        </li>
        <li class="info-item">
          <div class="name">{{ t("aboutpage.wails-repository") }}</div>
          <a class="link" href="https://github.com/wailsapp/wails">https://github.com/wailsapp/wails</a>
        </li>
        <li class="info-item">
          <div class="name">{{ t("aboutpage.author") }}</div>
          <a class="link" href="https://github.com/bestk">{{
            t("aboutpage.bestk")
          }}</a>
        </li>
      </ul>
